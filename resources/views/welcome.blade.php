...
@section('sidebar')
    <ul class="nav flex-column">
        <li class="nav-item"><a href="/laravel-links" target="_blank">Dit zijn de linkjes!</a></li>
        <li class="nav-item"><a href="/link-toevoegen" target="_blank">Voeg zelf een linkje toe!</a></li>
    </ul>
@endsection
